...
This report is structured around nine chapters: the first chapter is dedicated to presenting the general context of our project, including the host organization, the problem statement, and the proposed solution.
...
The remaining chapters are dedicated to presenting the work carried out throughout six sprints: project setup and message ingestion, subscription and business rules, notification delivery, AI prediction module, containerization and deployment, and finally observability and monitoring.
