...
\begin{itemize}
    ...
    \item \textbf{TaskManagers} with 2 task slots each (configurable via \texttt{TASK\_MANAGER\_NUMBER\_ OF\_TASK\_SLOTS}).
...
\section{Savepoints and Fault Tolerance}
...
\begin{enumerate}
    ...
    \begin{center}
        \centering
        \includegraphics[width=0.7\textwidth,height=9cm]{img/Build job}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=1\textwidth]{img/fortify job}
    ...
    \begin{center}
        \centering
        \includegraphics[width=1\textwidth]{img/sonar job}
